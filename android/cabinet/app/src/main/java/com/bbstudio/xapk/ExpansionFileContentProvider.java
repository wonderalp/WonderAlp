...
/**
 * Content provider for zipped file
 *
 * Heavily based on android.vending.expansion.zipfile.APEZProvider
 * License of APEZProvider :
 *
 ...
 */
public class ExpansionFileContentProvider extends ContentProvider {
    ...
    private boolean initIfNecessary() {
        if ( !mInit ) {
            ...
            ProviderInfo pi = pm.resolveContentProvider(Expansion.getProviderAuthority(), PackageManager.GET_META_DATA);
            ...
            if ( null != pi.metaData ) {
                ...
                mainFileVersion = Expansion.getMainVersion();
                patchFileVersion = Expansion.getPatchVersion();
            }
            try {
