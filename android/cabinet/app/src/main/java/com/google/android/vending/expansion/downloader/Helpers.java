...
public class Helpers {
     ...
     *
     * Modified so R does not need to be imported, added a context argument
     *
     * @param context Application context
     * @param state One of the STATE_* constants from {@link IDownloaderClient}.
     * @return string resource ID for the corresponding string.
     */
    static public int getDownloaderStringResourceIDFromState(Context context, int state) {
        String pkgName  = context.getPackageName();
        Resources res   = context.getResources();
        res.getIdentifier("obb_main_version", "integer", pkgName);

        switch (state) {
            case IDownloaderClient.STATE_IDLE:
                return res.getIdentifier("state_idle", "string", pkgName);
            case IDownloaderClient.STATE_FETCHING_URL:
                return res.getIdentifier("state_fetching_url", "string", pkgName);
            case IDownloaderClient.STATE_CONNECTING:
                return res.getIdentifier("state_connecting", "string", pkgName);
            case IDownloaderClient.STATE_DOWNLOADING:
                return res.getIdentifier("state_downloading", "string", pkgName);
            case IDownloaderClient.STATE_COMPLETED:
                return res.getIdentifier("state_completed", "string", pkgName);
            case IDownloaderClient.STATE_PAUSED_NETWORK_UNAVAILABLE:
                return res.getIdentifier("state_paused_network_unavailable", "string", pkgName);
            case IDownloaderClient.STATE_PAUSED_BY_REQUEST:
                return res.getIdentifier("state_paused_by_request", "string", pkgName);
            case IDownloaderClient.STATE_PAUSED_WIFI_DISABLED_NEED_CELLULAR_PERMISSION:
                return res.getIdentifier("state_paused_wifi_disabled", "string", pkgName);
            case IDownloaderClient.STATE_PAUSED_NEED_CELLULAR_PERMISSION:
                return res.getIdentifier("state_paused_wifi_unavailable", "string", pkgName);
            case IDownloaderClient.STATE_PAUSED_WIFI_DISABLED:
                return res.getIdentifier("state_paused_wifi_disabled", "string", pkgName);
            case IDownloaderClient.STATE_PAUSED_NEED_WIFI:
                return res.getIdentifier("state_paused_wifi_unavailable", "string", pkgName);
            case IDownloaderClient.STATE_PAUSED_ROAMING:
                return res.getIdentifier("state_paused_roaming", "string", pkgName);
            case IDownloaderClient.STATE_PAUSED_NETWORK_SETUP_FAILURE:
                return res.getIdentifier("state_paused_network_setup_failure", "string", pkgName);
            case IDownloaderClient.STATE_PAUSED_SDCARD_UNAVAILABLE:
                return res.getIdentifier("state_paused_sdcard_unavailable", "string", pkgName);
            case IDownloaderClient.STATE_FAILED_UNLICENSED:
                return res.getIdentifier("state_failed_unlicensed", "string", pkgName);
            case IDownloaderClient.STATE_FAILED_FETCHING_URL:
                return res.getIdentifier("state_failed_fetching_url", "string", pkgName);
            case IDownloaderClient.STATE_FAILED_SDCARD_FULL:
                return res.getIdentifier("state_failed_sdcard_full", "string", pkgName);
            case IDownloaderClient.STATE_FAILED_CANCELED:
                return res.getIdentifier("state_failed_cancelled", "string", pkgName);
            default:
                return res.getIdentifier("state_unknown", "string", pkgName);
        }
    }
